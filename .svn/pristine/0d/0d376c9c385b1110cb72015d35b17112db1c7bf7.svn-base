...
function searchGridByBtn(tblId, isByHeader,thiss) {
...
function generatePagesNumber(tblId, pageSize, startIndex, maxPageToBeDisplayedAtBottom) {
    ...
    if (currentPage == 1) {
        ...
        $("#" + tblId + " #pagesGenerated").append("<li><a href='javascript:void(0)' onclick=lbtnNextPrev_Command('" + tblId + "','',1)  ><i class='fa fa-fw fa-fast-backward'></i></a></li>");
        $("#" + tblId + " #pagesGenerated").append("<li><a href='javascript:void(0)' onclick=lbtnNextPrev_Command('" + tblId + "','Prev')  ><i class='fa fa-fw fa-backward'></i></a></li>");
    }
